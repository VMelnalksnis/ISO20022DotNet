...
namespace VMelnalksnis.ISO20022DotNet.MessageSets.BankToCustomerCashManagement.V2.AccountReport
{
	...
	[Serializable]
	[XmlType("AlternateSecurityIdentification2", Namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")]
	[DebuggerStepThrough]
	[DesignerCategory("code")]
	public sealed record AlternateSecurityIdentification2
	{
		/// <summary>
