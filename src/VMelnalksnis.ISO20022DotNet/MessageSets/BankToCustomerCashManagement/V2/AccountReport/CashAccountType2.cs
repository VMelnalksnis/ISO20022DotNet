...
namespace VMelnalksnis.ISO20022DotNet.MessageSets.BankToCustomerCashManagement.V2.AccountReport
{
	...
	[Serializable]
	[XmlType("CashAccountType2", Namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")]
	[DebuggerStepThrough]
	[DesignerCategory("code")]
	public sealed record CashAccountType2
	{
		[EditorBrowsable(EditorBrowsableState.Never)]
		[XmlElement("Cd")]
		public CashAccountType4Code CdValue { get; init; }
		...
		[XmlIgnore]
		public CashAccountType4Code? Cd
		{
			get
			{
				if (CdValueSpecified)
