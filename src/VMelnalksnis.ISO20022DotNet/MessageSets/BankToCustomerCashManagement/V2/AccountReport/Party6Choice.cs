...
namespace VMelnalksnis.ISO20022DotNet.MessageSets.BankToCustomerCashManagement.V2.AccountReport
{
	...
	{
		/// <summary>
		/// Gets unique and unambiguous way to identify an organisation.
		/// </summary>
		[XmlElement("OrgId")]
		public OrganisationIdentification4? OrganisationIdentification { get; init; }

		/// <summary>
		/// Gets unique and unambiguous identification of a person, eg, passport.
		/// </summary>
		[XmlElement("PrvtId")]
		public PersonIdentification5? PrivateIdentification { get; init; }
	}
}
