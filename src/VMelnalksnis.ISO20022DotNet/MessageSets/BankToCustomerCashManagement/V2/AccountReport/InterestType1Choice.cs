...
namespace VMelnalksnis.ISO20022DotNet.MessageSets.BankToCustomerCashManagement.V2.AccountReport
{
	...
	[Serializable]
	[XmlType("InterestType1Choice", Namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")]
	[DebuggerStepThrough]
	[DesignerCategory("code")]
	public sealed record InterestType1Choice
	{
		[EditorBrowsable(EditorBrowsableState.Never)]
		[XmlElement("Cd")]
		public InterestType1Code CdValue { get; init; }
