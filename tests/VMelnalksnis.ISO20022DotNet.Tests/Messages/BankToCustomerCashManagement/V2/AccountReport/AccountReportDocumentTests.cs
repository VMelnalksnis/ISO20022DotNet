...
using VMelnalksnis.ISO20022DotNet.Messages.BankToCustomerCashManagement.V2.AccountReport;

namespace VMelnalksnis.ISO20022DotNet.Tests.Messages.BankToCustomerCashManagement.V2.AccountReport
{
	public class AccountReportDocumentTests
	{
		...
		public void ReadActualDocument()
		{
			...
			var directory = Path.Combine(
				...
				"Messages/BankToCustomerCashManagement/V2/AccountReport/");
